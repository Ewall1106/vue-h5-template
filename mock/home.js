export default [
  ...
  {
    url: '/prod-api/home/list',
    type: 'post',
    response: config => {
      const { pageSize, pageNum } = JSON.parse(config.body)

      const list = [
        {
          img: 'https://img9.doubanio.com/view/subject/s/public/s33531914.jpg',
          title: '小行星掉在下午',
          desc: '作者：沈大成',
          price: 1000,
          discount: 888
        ...
        {
          img: 'https://img9.doubanio.com/view/subject/s/public/s33557944.jpg',
          title: '我的不朽已然足够',
        ...
        {
          img: 'https://img9.doubanio.com/view/subject/s/public/s33542046.jpg',
          title: '饱食穷民',
          desc: '作者：[日]斋藤茂男',
          price: 1233,
          discount: 987
        ...
        {
          img: 'https://img9.doubanio.com/view/subject/s/public/s33513675.jpg',
          title: '马可瓦尔多',
          desc: '作者：[意] 伊塔洛·卡尔维诺',
          price: 5343,
          discount: 986
        ...
        {
          img: 'https://img1.doubanio.com/view/subject/s/public/s33576238.jpg',
          title: '致命流感',
          desc: '作者：[美] 杰瑞米·布朗',
          price: 5553,
          discount: 986
        ...
        {
          img: 'https://img9.doubanio.com/view/subject/s/public/s33534105.jpg',
          title: '去往猴面包树的旅程',
        ...
        {
          img: 'https://img3.doubanio.com/view/subject/s/public/s33557662.jpg',
          title: '赞扬与责备',
        ...
        {
          img: 'https://img3.doubanio.com/view/subject/s/public/s33531932.jpg',
          title: '吃',
      ...
      if (!pageSize || !pageNum || pageSize <= 0 || pageNum <= 0) {
        ...
        return {
          code: 200,
          entry: list.slice(
            Number((pageSize - 1) * pageNum),
            (pageSize - 1) * pageNum + pageNum
          )
        }
      }
    }
