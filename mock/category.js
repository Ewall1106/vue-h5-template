...

  {
    ...
    response: config => {
      const list = [
        ...
        {
          banner:
            'http://img61.ddimg.cn/upload_img/00803/1/886x315-1585620617.jpg',
          listItem: [
            {
              title: '教育考试',
              content: [
      ...
      const { index } = JSON.parse(config.body)
      return {
        code: 200,
        entry: list[index]
      }
